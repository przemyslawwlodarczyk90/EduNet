...
public class NetworkTypeCatalog {
    ...
    private final List<NetworkType> types = List.of(
            ...
            new NetworkType("CAN", "CAN — sieć kampusowa", "kilka sąsiednich budynków jednej organizacji",
                    "Sieć łącząca kilka pobliskich budynków należących do jednej organizacji (np. kampus uczelni lub zakładu), zwykle własną infrastrukturą światłowodową — większa niż LAN, ale mniejsza i jednorodniejsza niż MAN.",
                    "Sieć łącząca budynki wydziałów jednej uczelni własnym światłowodem"),
